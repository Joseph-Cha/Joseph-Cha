# Tasks: Pivot Profile to Web & AI Engineering

- [x] Pivot profile focus to Web & AI Engineering <!-- id: 13 -->
  - [x] Update title and introduction in README.md <!-- id: 14 -->
  - [x] Replace console ASCII art with monitor/AI terminal ASCII art <!-- id: 15 -->
