...
| Project | Description | Tech Stack | Type |
| :--- | :--- | :--- | :---: |
| **[pumeun_gido](https://github.com/Joseph-Cha/pumeun_gido)** | 지인으로부터 전달받은 기도 제목을 체계적으로 정리하고 관리하는 기도 동반자 앱 | `Flutter` `Dart` | Public |
| **[MeetingRoomReservationSystem](https://github.com/Joseph-Cha/MeetingRoomReservationSystem)** | 여의도 순복음 교회 제2교육관 8층 모임 장소 예약 페이지 | `C#` `.NET` | Public |

### 🎮 Game Development & Architecture
| Project | Description | Tech Stack | Type | Stars |
| :--- | :--- | :--- | :---: | :---: |
| **[ArchitectureStudyForUnity](https://github.com/Joseph-Cha/ArchitectureStudyForUnity)** | MVP & MVVM 디자인 패턴 심층 학습 및 구현 | `Unity` `C#` `Design Patterns` | Public | ![Stars](https://img.shields.io/github/stars/Joseph-Cha/ArchitectureStudyForUnity?style=flat&label=) |
| **[UnityUIRotation](https://github.com/Joseph-Cha/UnityUIRotation)** | 화면 방향 변화에 따른 반응형 UI 회전 처리 모듈 | `Unity` `C#` `UI/UX` | Public | ![Stars](https://img.shields.io/github/stars/Joseph-Cha/UnityUIRotation?style=flat&label=) |
...
| Project | Description | Tech Stack | Type |
| :--- | :--- | :--- | :---: |
| **[bhook](https://github.com/Joseph-Cha/bhook)** | Android PLT hook library supporting armeabi-v7a, arm64-v8a, x86 & x86_64 | `C` `Android` `JNI` | Public |
| **[AlgorithmStudy](https://github.com/Joseph-Cha/AlgorithmStudy)** | 자료구조 및 알고리즘 문제 풀이 스터디 저장소 | `C++` `Data Structure` | Public |
...
<a href="https://github.com/ryo-ma/github-profile-trophy">
  <img src="https://github-profile-trophy.vercel.app/?username=Joseph-Cha&theme=dracula" alt="Joseph-Cha Trophies" />
</a>
...
<table>
  <tr>
    <td align="center">
      <img src="https://github-readme-stats-fast.vercel.app/api?username=Joseph-Cha&show_icons=true&theme=dracula&count_private=true" alt="Joseph-Cha Stats" height="195" />
    </td>
    <td align="center">
      <img src="https://github-readme-stats-fast.vercel.app/api/top-langs/?username=Joseph-Cha&layout=compact&theme=dracula&count_private=true&langs_count=8" alt="Top Languages" height="195" />
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2">
      <img src="https://github-readme-streak-stats.herokuapp.com/?user=Joseph-Cha&theme=dracula" alt="GitHub Streak Stats" width="100%" />
    </td>
  </tr>
</table>
...
- 🎯 **Knowledge Sharing** - Contributing to and growing with the developer community.
- 🚀 **Continuous Learning** - Keeping pace with industry transitions and learning new tech stacks.
- ✝️ **Purpose-Driven Development** - Coding for something greater than profit, using tech to serve the kingdom.
